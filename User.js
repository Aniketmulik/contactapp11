...
let user1 =admin.createUser("pavan","M",22);
...
//error
//let user1 =admin.createUser("pavan",2,22);
//admin.createContact("shubham","India");
//user1.createContactInfo(7,"Navi Mumbai","ghansoli");
//console.log(user1);
